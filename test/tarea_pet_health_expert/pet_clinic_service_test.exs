defmodule TareaPetHealthExpert.PetClinicServiceTest do
  use TareaPetHealthExpert.DataCase

  alias TareaPetHealthExpert.PetClinicService

  describe "pets" do
    alias TareaPetHealthExpert.PetClinicService.Pet

    import TareaPetHealthExpert.PetClinicServiceFixtures
